package com.homebase.homebase_backend.config;

import com.homebase.homebase_backend.auth.jwt.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    // to give Spring more control over bean resolution order
